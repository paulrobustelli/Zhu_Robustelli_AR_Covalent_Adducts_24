...
cluster_com_E2E7.ipynb is for clustering the combined trajectory of non-covalent trajectory $Tau-5_{R2_R3}$ in the presence of EPI-002 and EPI-7170 with 4 clusters.
